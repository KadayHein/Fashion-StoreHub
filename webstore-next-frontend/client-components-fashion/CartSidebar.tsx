...
export default function CartSidebar({toggleCartSide}:any) {
  ...
  return (
    ...
    <Box sx={{ position: "fixed", bottom: 0, right: 0, width: 500,
    ...
    <div className="grid grid-cols-2 gap-4 mt-3">
        <Button fullWidth variant="outlined" sx={{borderColor: "#9CA3AF", color: "#374151", borderRadius: "999px", 
        ...
        <Button href={"/fashion/clientstore/checkout/0"} onClick={toggleCartSide(false)} fullWidth variant="outlined" sx={{bgcolor: "black", color: "white", borderColor: "#9CA3AF", borderRadius: "999px", 
